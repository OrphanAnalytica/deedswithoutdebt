---
title: "Georgia Tax Sales Guide"
slug: "georgia"
type: "hybrid"
difficulty: "intermediate"
status: "available"
summary: "Redeemable deeds; First Tuesday tradition; 20% interest if redeemed."
last_updated: "2025-09-05"
---

# Georgia Tax Sales Guide

## Overview
- System: **Hybrid** (redeemable tax deed with 1-year redemption period)
- Frequency: First Tuesday of every month
- Format: Live courthouse steps auctions

## How the Sales Work
1) **Where to find the list**: County websites publish lists 4 weeks before auction
2) **Who runs the sale**: County sheriff at courthouse steps, 10:00 AM
3) **Key deadlines / redemption rules**: 1-year redemption period, 20% interest if redeemed
4) **Payment rules**: Payment typically due immediately or same day, cashier's check

## Due Diligence Checklist
- **Assessor lookup**: County tax assessor websites for GIS and property details
- **Title/Liens considerations**: Environmental and federal liens survive deed sales
- **Code/Flood/Access checks**: Verify legal access, flood zones, timber rights
- **Occupancy and possession notes**: Immediate ownership but 1-year redemption risk

## Strategy Notes
- **Typical entry prices**: $1,000-$15,000 for rural properties, higher in metro areas
- **What beginners miss**: Redemption likelihood analysis, homestead protections
- **Exit paths**: 20% return on redemption, property ownership if not redeemed

## Contacts
- **County Sheriffs**: Conduct auctions first Tuesday each month
- **County Tax Commissioners**: Tax records and procedures
