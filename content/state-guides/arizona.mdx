---
title: "Arizona Tax Sales Guide"
slug: "arizona"
type: "lien"
difficulty: "beginner"
status: "available"
summary: "Certificate auctions; competitive bidding; strong redemption rates."
last_updated: "2025-09-05"
---

# Arizona Tax Sales Guide

## Overview
- System: **Lien** (tax lien certificates, 16% interest maximum)
- Frequency: Annual county auctions (February-May typically)
- Format: Competitive certificate bidding

## How the Sales Work
1) **Where to find the list**: County treasurer websites publish certificate lists
2) **Who runs the sale**: County treasurer at courthouse or convention center
3) **Key deadlines / redemption rules**: 2-3 year redemption period, 16% interest maximum
4) **Payment rules**: Typically cashier's check or wire, payment due same day or next business day

## Due Diligence Checklist
- **Assessor lookup**: County assessor websites for GIS and property details
- **Title/Liens considerations**: Research HOA liens, outstanding judgments
- **Code/Flood/Access checks**: Verify water availability, access roads, desert property challenges
- **Occupancy and possession notes**: High redemption rates, especially in growth counties

## Strategy Notes
- **Typical entry prices**: $500-$10,000 for certificates
- **What beginners miss**: Water rights issues, extreme heat property damage
- **Exit paths**: Interest collection on redemption, occasional foreclosure to ownership

## Contacts
- **County Treasurers**: Each county runs separate annual auctions
- **County Assessors**: Property research and valuation
