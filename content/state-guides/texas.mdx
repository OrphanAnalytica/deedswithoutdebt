---
title: "Texas Tax Sales Guide"
slug: "texas"
type: "deed"
difficulty: "advanced"
status: "available"
summary: "First Tuesday courthouse auctions; strong property rights; oil & gas considerations."
last_updated: "2025-09-05"
---

# Texas Tax Sales Guide

## Overview
- System: **Deed** (immediate ownership transfer, no redemption period)
- Frequency: Monthly (first Tuesday of every month)
- Format: Live courthouse steps auction

## How the Sales Work
1) **Where to find the list**: County websites publish lists 21-23 days before auction
2) **Who runs the sale**: County sheriff or constable at courthouse steps
3) **Key deadlines / redemption rules**: No redemption period - deed transfer is immediate
4) **Payment rules**: Full payment typically due next business day, cashier's check or wire

## Due Diligence Checklist
- **Assessor lookup**: County appraisal district websites for GIS and property details
- **Title/Liens considerations**: Federal liens survive; check for IRS, judgment liens
- **Code/Flood/Access checks**: Verify legal access, flood zones, deed restrictions
- **Occupancy and possession notes**: Homestead properties have additional protections

## Strategy Notes
- **Typical entry prices**: $5,000-$50,000+ in major metros, $2,500-$15,000 rural
- **What beginners miss**: Homestead exemption issues, oil/gas rights complexity
- **Exit paths**: Urban infill development, rural subdivision, resource extraction

## Contacts
- **County Sheriff/Constable**: Varies by county for auction conduct
- **County Tax Assessor-Collector**: Tax information and procedures
