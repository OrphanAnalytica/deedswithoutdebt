---
title: "Florida Tax Sales Guide"
slug: "florida"
type: "lien"
difficulty: "beginner"
status: "available"
summary: "Certificate state; online bidding; hurricane recovery opportunities."
last_updated: "2025-09-05"
---

# Florida Tax Sales Guide

## Overview
- System: **Lien** (tax lien certificates, 18% interest maximum)
- Frequency: Annual certificate sales (May-June typically)
- Format: Online bidding platforms

## How the Sales Work
1) **Where to find the list**: County tax collector websites publish certificate lists
2) **Who runs the sale**: County tax collector via online auction platforms
3) **Key deadlines / redemption rules**: 2-year redemption period, 18% interest maximum
4) **Payment rules**: Online payment typically due within 24-48 hours

## Due Diligence Checklist
- **Assessor lookup**: County property appraiser websites for GIS and property details
- **Title/Liens considerations**: Homestead properties protected, research outstanding liens
- **Code/Flood/Access checks**: Verify flood zones, code violations, HOA issues
- **Occupancy and possession notes**: High redemption rates, homestead properties rarely convert to deeds

## Strategy Notes
- **Typical entry prices**: $100-$5,000 for certificates
- **What beginners miss**: Bidding rates down too aggressively, homestead protections
- **Exit paths**: Interest collection on redemption, occasional deed conversion

## Contacts
- **County Tax Collectors**: Each county runs separate online auctions
- **Property Appraisers**: Property research and valuation
